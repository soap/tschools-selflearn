...
class GrantPermissionCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'permission:grant-permission
        {--user : Grant permission(s) to user}
        {--role : Grant permission(s) to role}';
     ...
     * @var string
     */
    protected $description = 'Grant permission(s) to user or role';
